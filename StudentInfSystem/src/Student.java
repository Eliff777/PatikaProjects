public class Student {
    ...
    public void printNote(){
        ...
        System.out.println("Fizik     , sınav notu : " + this.fizik.note +" , Sözlü notu : "+ this.fizik.verbalNote +"   Oran ==> sınav %75  sözlü %25");
        System.out.println("Kimya     , sınav notu : " + this.kimya.note +" , Sözlü notu : "+ this.kimya.verbalNote +"   Oran ==> sınav %60  sözlü %40");
    }
}
